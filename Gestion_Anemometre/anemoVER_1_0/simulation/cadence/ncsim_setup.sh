...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/anemoVER_1_0_RAM.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/anemoVER_1_0_RAM.vhd"   -work RAM   -cdslib ./cds_libs/RAM.cds.lib  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/anemoVER_1_0_DEBUG.vhd" -work DEBUG -cdslib ./cds_libs/DEBUG.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/anemoVER_1_0_CPU.v"     -work CPU   -cdslib ./cds_libs/CPU.cds.lib  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/anemoVER_1_0.vhd"                                                              
fi
